...
const App = (state) => {
    ...
    <main>
        ...
        <section>
            ...
            <strong>${roversName(rovers)}</strong>
            <p>
                ${roversText(rovers)}
            </p>
            <div class='wrapper'>
                ...
                <div id='photo'>${ImageOfTheDay(apod)}</div>
            </div>
        </section>
    </main>
    <footer></footer>
...
const ImageOfTheDay = (apod) => {
    ...
    const photodate = new Date(apod)
    if (!apod || apod.date === today.getDate() || apod.chosenRover !== store.chosenRover ) {
...
const roversName = () => {
    if(store.chosenRover == 'Curiosity'){
        return `Curiosity Rover.`
    } else if (store.chosenRover == 'Opportunity') {
        return `Opportunity Rover.`
    } else if (store.chosenRover == 'Spirit'){
        return `Spirit Rover.`
    }
}
